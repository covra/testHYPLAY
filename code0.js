...
};gdjs.MainCode.mapOfGDgdjs_9546MainCode_9546GDtest_95959595shipObjects3Objects = Hashtable.newFrom({"test_ship": gdjs.MainCode.GDtest_9595shipObjects3});
...
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.MainCode.GDtest_9595shipObjects3, gdjs.MainCode.GDtest_9595shipObjects4);

{for(var i = 0, len = gdjs.MainCode.GDtest_9595shipObjects4.length ;i < len;++i) {
    gdjs.MainCode.GDtest_9595shipObjects4[i].setColor("184;233;134");
}
}}
...
{for(var i = 0, len = gdjs.MainCode.GDtest_9595shipObjects3.length ;i < len;++i) {
    gdjs.MainCode.GDtest_9595shipObjects3[i].setColor("208;2;27");
}
}}
...
gdjs.copyArray(gdjs.MainCode.GDtest_9595shipObjects2, gdjs.MainCode.GDtest_9595shipObjects3);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.MainCode.mapOfGDgdjs_9546MainCode_9546GDtest_95959595shipObjects3Objects, runtimeScene, false, false);
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtTools.input.cursorOnObject(gdjs.MainCode.mapOfGDgdjs_9546MainCode_9546GDtest_95959595shipObjects2Objects, runtimeScene, false, true);
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10612628);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.asyncCallback10625324 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.MainCode.asyncCallback10625324(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getScene().getVariables().getFromIndex(17), true);
if (isConditionTrue_0) {
gdjs.copyArray(gdjs.MainCode.GDtest_9595debrisObjects2, gdjs.MainCode.GDtest_9595debrisObjects3);

gdjs.copyArray(gdjs.MainCode.GDtest_9595shipObjects2, gdjs.MainCode.GDtest_9595shipObjects3);

{for(var i = 0, len = gdjs.MainCode.GDtest_9595debrisObjects3.length ;i < len;++i) {
    gdjs.MainCode.GDtest_9595debrisObjects3[i].addForceTowardObject((gdjs.MainCode.GDtest_9595shipObjects3.length !== 0 ? gdjs.MainCode.GDtest_9595shipObjects3[0] : null), 100, 0);
}
}}
...
};gdjs.MainCode.asyncCallback10636948 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.MainCode.asyncCallback10636948(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10636356);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x90ef18 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x90ef18(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x913530 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
/*
...
gdjs.MainCode.userFunc0x913530(runtimeScene, objects);
...
};gdjs.MainCode.asyncCallback10645948 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.MainCode.asyncCallback10645948(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10639988);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x9bb988 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDbad_9595RockObjects3);
gdjs.MainCode.userFunc0x9bb988(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x9076c0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDtest_9595shipObjects3);
gdjs.MainCode.userFunc0x9076c0(runtimeScene, objects);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10647060);
}
}
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.MainCode.eventsList30(runtimeScene);} //End of subevents
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(10649340);
}
}
if (isConditionTrue_0) {

...
gdjs.splashScreenCode.userFunc0x13510b8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
//Definitions
const bk = objects[0];
...
gdjs.splashScreenCode.userFunc0x13510b8(runtimeScene, objects);
...
};gdjs.splashScreenCode.asyncCallback16272852 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.splashScreenCode.asyncCallback16272852(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16272932);
}
}
if (isConditionTrue_0) {

...
};gdjs.LeaderboardCode.asyncCallback16481628 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback16481628(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LeaderboardCode.userFunc0xd7a850 = function GDJSInlineCode(runtimeScene) {
"use strict";
...
gdjs.LeaderboardCode.userFunc0xd7a850(runtimeScene);
...
};gdjs.LeaderboardCode.asyncCallback16504604 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(2), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback16504604(runtimeScene, asyncObjectsList)));
}
}

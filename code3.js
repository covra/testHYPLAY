...
gdjs.splashScreenCode.userFunc0x10bd878 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
//Definitions
const bk = objects[0];
...
gdjs.splashScreenCode.userFunc0x10bd878(runtimeScene, objects);
...
};gdjs.splashScreenCode.asyncCallback16547972 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.splashScreenCode.asyncCallback16547972(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16548052);
}
}
if (isConditionTrue_0) {

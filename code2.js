...
};gdjs.LeaderboardCode.asyncCallback16670644 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback16670644(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LeaderboardCode.asyncCallback16670004 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);
/* Don't save BlueButton as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__ScrapGameFunctions__AddScoreFireBase.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback16670004(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LeaderboardCode.asyncCallback16669740 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback16669740(runtimeScene, asyncObjectsList)));
}
}

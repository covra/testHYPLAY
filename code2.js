...
};gdjs.MainCode.userFunc0x14e85c8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x14e85c8(runtimeScene, objects);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15985444);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(15993620);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.asyncCallback16008084 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.MainCode.asyncCallback16008084(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.MainCode.asyncCallback16018796 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.MainCode.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.MainCode.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.MainCode.asyncCallback16018796(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16018284);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x14ef170 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x14ef170(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x14ef4a8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
/*
...
gdjs.MainCode.userFunc0x14ef4a8(runtimeScene, objects);
...
};gdjs.MainCode.asyncCallback16028308 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.MainCode.localVariables);
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.MainCode.asyncCallback16028308(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16022500);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x14f0340 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDbad_9595RockObjects3);
gdjs.MainCode.userFunc0x14f0340(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x14f0740 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDtest_9595shipObjects3);
gdjs.MainCode.userFunc0x14f0740(runtimeScene, objects);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16029492);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(16035268);
}
}
if (isConditionTrue_0) {

...
gdjs.LeaderboardCode.GDnameIputFakeObjects6= [];
...
gdjs.LeaderboardCode.GDBlueButtonObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595titleObjects6= [];
...
gdjs.LeaderboardCode.GDIDIputFakeObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595title2Objects6= [];
...
gdjs.LeaderboardCode.GDcajaObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595posObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595nameObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595scoreObjects6= [];
...
gdjs.LeaderboardCode.GDfondonameObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595debujLeaderObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595title3Objects6= [];
...
gdjs.LeaderboardCode.GDscoreInputFakeObjects6= [];
...
gdjs.LeaderboardCode.GDmainObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595title4Objects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595title5Objects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595title6Objects6= [];
...
gdjs.LeaderboardCode.GDbgObjects5= [];
gdjs.LeaderboardCode.GDbgObjects6= [];
...
gdjs.LeaderboardCode.GDtxt_9595gameVersionObjects5= [];
gdjs.LeaderboardCode.GDtxt_9595gameVersionObjects6= [];
...
{
{runtimeScene.getScene().getVariables().getFromIndex(6).getChild("playerId").setString(gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().getFromIndex(2).getChild("username")));
...
};gdjs.LeaderboardCode.asyncCallback17224492 = function (runtimeScene, asyncObjectsList) {
...
}{for(var i = 0, len = gdjs.LeaderboardCode.GDBlueButtonObjects6.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDBlueButtonObjects6[i].SetLabelText("Close", (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback17224492(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LeaderboardCode.asyncCallback17223852 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);

{ //Subevents
gdjs.LeaderboardCode.eventsList2(runtimeScene, asyncObjectsList);} //End of subevents
}
gdjs.LeaderboardCode.eventsList3 = function(runtimeScene, asyncObjectsList) {
...
asyncObjectsList.backupLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);
/* Don't save BlueButton as it will be provided by the parent asyncObjectsList. */
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__ScrapGameFunctions__AddScoreFireBase.func(runtimeScene, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback17223852(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LeaderboardCode.asyncCallback17223588 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.LeaderboardCode.localVariables);

{ //Subevents
gdjs.LeaderboardCode.eventsList3(runtimeScene, asyncObjectsList);} //End of subevents
}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LeaderboardCode.asyncCallback17223588(runtimeScene, asyncObjectsList)));
}
}
...
{for(var i = 0, len = gdjs.LeaderboardCode.GDtxt_9595titleObjects2.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDtxt_9595titleObjects2[i].getBehavior("Text").setText(runtimeScene.getGame().getVariables().getFromIndex(2).getChild("id").getAsString());
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDtxt_9595title2Objects2.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDtxt_9595title2Objects2[i].getBehavior("Text").setText(runtimeScene.getGame().getVariables().getFromIndex(2).getChild("username").getAsString());
}
}{for(var i = 0, len = gdjs.LeaderboardCode.GDtxt_9595title3Objects2.length ;i < len;++i) {
    gdjs.LeaderboardCode.GDtxt_9595title3Objects2[i].getBehavior("Text").setText(gdjs.evtTools.common.toString(runtimeScene.getGame().getVariables().getFromIndex(11).getAsNumber()));
}
}
{ //Subevents
...
{runtimeScene.getGame().getVariables().getFromIndex(2).getChild("id").setString((( gdjs.LeaderboardCode.GDIDIputFakeObjects2.length === 0 ) ? "" :gdjs.LeaderboardCode.GDIDIputFakeObjects2[0].getText()));
}{runtimeScene.getGame().getVariables().getFromIndex(2).getChild("username").setString((( gdjs.LeaderboardCode.GDIDIputFakeObjects2.length === 0 ) ? "" :gdjs.LeaderboardCode.GDIDIputFakeObjects2[0].getText()));
}{runtimeScene.getGame().getVariables().getFromIndex(11).setNumber(gdjs.evtTools.common.toNumber((( gdjs.LeaderboardCode.GDscoreInputFakeObjects2.length === 0 ) ? "" :gdjs.LeaderboardCode.GDscoreInputFakeObjects2[0].getText())));
}
{ //Subevents
...
gdjs.LeaderboardCode.GDnameIputFakeObjects6.length = 0;
...
gdjs.LeaderboardCode.GDBlueButtonObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595titleObjects6.length = 0;
...
gdjs.LeaderboardCode.GDIDIputFakeObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595title2Objects6.length = 0;
...
gdjs.LeaderboardCode.GDcajaObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595posObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595nameObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595scoreObjects6.length = 0;
...
gdjs.LeaderboardCode.GDfondonameObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595debujLeaderObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595title3Objects6.length = 0;
...
gdjs.LeaderboardCode.GDscoreInputFakeObjects6.length = 0;
...
gdjs.LeaderboardCode.GDmainObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595title4Objects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595title5Objects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595title6Objects6.length = 0;
...
gdjs.LeaderboardCode.GDbgObjects5.length = 0;
gdjs.LeaderboardCode.GDbgObjects6.length = 0;
...
gdjs.LeaderboardCode.GDtxt_9595gameVersionObjects5.length = 0;
gdjs.LeaderboardCode.GDtxt_9595gameVersionObjects6.length = 0;

...
gdjs.SplashSceneCode.GDskipObjects2_1final = [];
...
gdjs.SplashSceneCode.userFunc0x12128d0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.SplashSceneCode.userFunc0x12128d0(runtimeScene, objects);
...
};gdjs.SplashSceneCode.asyncCallback14516300 = function (runtimeScene, asyncObjectsList) {
}
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__AdvancedHTTP__ExecuteRequest.func(runtimeScene, "HYPLAYGetUser", runtimeScene.getScene().getVariables().getFromIndex(1), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.SplashSceneCode.asyncCallback14516300(runtimeScene, asyncObjectsList)));
}
}
...
let isConditionTrue_0 = false;
{
{runtimeScene.getGame().getVariables().getFromIndex(1).getChild("id").setString(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(2).getChild("id")));
}{runtimeScene.getGame().getVariables().getFromIndex(1).getChild("username").setString(gdjs.evtTools.variable.getVariableString(runtimeScene.getScene().getVariables().getFromIndex(2).getChild("username")));
}}

}


};gdjs.SplashSceneCode.asyncCallback14521404 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__AdvancedHTTP__ReadResponseJSON.func(runtimeScene, runtimeScene.getScene().getVariables().getFromIndex(1), runtimeScene.getScene().getVariables().getFromIndex(2), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.SplashSceneCode.asyncCallback14521404(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14521116);
}
}
if (isConditionTrue_0) {
...
};gdjs.SplashSceneCode.asyncCallback14525596 = function (runtimeScene, asyncObjectsList) {
gdjs.copyArray(runtimeScene.getObjects("txt_debug2"), gdjs.SplashSceneCode.GDtxt_9595debug2Objects2);
{for(var i = 0, len = gdjs.SplashSceneCode.GDtxt_9595debug2Objects2.length ;i < len;++i) {
    gdjs.SplashSceneCode.GDtxt_9595debug2Objects2[i].getBehavior("Text").setText(runtimeScene.getGame().getVariables().getFromIndex(1).getChild("username").getAsString() + " you are joining the game...");
}
}
{ //Subevents
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.SplashSceneCode.asyncCallback14525596(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(14511596);
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{gdjs.SplashSceneCode.GDskipObjects2_1final.length = 0;
let isConditionTrue_1 = false;
isConditionTrue_0 = false;
{
...
{
gdjs.copyArray(runtimeScene.getObjects("skip"), gdjs.SplashSceneCode.GDskipObjects3);
for (var i = 0, k = 0, l = gdjs.SplashSceneCode.GDskipObjects3.length;i<l;++i) {
    if ( gdjs.SplashSceneCode.GDskipObjects3[i].IsPressed((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_1 = true;
        gdjs.SplashSceneCode.GDskipObjects3[k] = gdjs.SplashSceneCode.GDskipObjects3[i];
        ++k;
    }
}
gdjs.SplashSceneCode.GDskipObjects3.length = k;
if(isConditionTrue_1) {
    isConditionTrue_0 = true;
    for (let j = 0, jLen = gdjs.SplashSceneCode.GDskipObjects3.length; j < jLen ; ++j) {
        if ( gdjs.SplashSceneCode.GDskipObjects2_1final.indexOf(gdjs.SplashSceneCode.GDskipObjects3[j]) === -1 )
            gdjs.SplashSceneCode.GDskipObjects2_1final.push(gdjs.SplashSceneCode.GDskipObjects3[j]);
    }
}
}
{
gdjs.copyArray(gdjs.SplashSceneCode.GDskipObjects2_1final, gdjs.SplashSceneCode.GDskipObjects2);
}
}
if (isConditionTrue_0) {

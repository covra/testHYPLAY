...
gdjs.SplashSceneCode.userFunc0x9d30d0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.SplashSceneCode.userFunc0x9d30d0(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xa10078 = function GDJSInlineCode(runtimeScene) {
"use strict";
setTimeout(()=>{
...
gdjs.SplashSceneCode.userFunc0xa10078(runtimeScene);
...
};gdjs.SplashSceneCode.userFunc0x9af500 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
...
gdjs.SplashSceneCode.userFunc0x9af500(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xe0df48 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
const tokenAuth = runtimeScene.getGame().getVariables().get("sessionAccessToken").getAsString();
const globalUserStruct = runtimeScene.getGame().getVariables().get("currentUser");
...
var objects = [];
objects.push.apply(objects,gdjs.SplashSceneCode.GDtxt_9595debug2Objects3);
gdjs.SplashSceneCode.userFunc0xe0df48(runtimeScene, objects);

...
gdjs.SplashSceneCode.userFunc0xbd8d00 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.SplashSceneCode.userFunc0xbd8d00(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xdd2288 = function GDJSInlineCode(runtimeScene) {
"use strict";
setTimeout(()=>{
...
gdjs.SplashSceneCode.userFunc0xdd2288(runtimeScene);
...
};gdjs.SplashSceneCode.userFunc0xe68ad0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
...
gdjs.SplashSceneCode.userFunc0xe68ad0(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xe69640 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
const tokenAuth = runtimeScene.getGame().getVariables().get("sessionAccessToken").getAsString();
const globalUserStruct = runtimeScene.getGame().getVariables().get("currentUser");
...
var objects = [];
objects.push.apply(objects,gdjs.SplashSceneCode.GDtxt_9595debug2Objects3);
gdjs.SplashSceneCode.userFunc0xe69640(runtimeScene, objects);

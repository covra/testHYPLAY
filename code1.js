...
gdjs.SplashSceneCode.userFunc0x900bb0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.SplashSceneCode.userFunc0x900bb0(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0x10decb0 = function GDJSInlineCode(runtimeScene) {
"use strict";
setTimeout(()=>{
...
gdjs.SplashSceneCode.userFunc0x10decb0(runtimeScene);
...
};gdjs.SplashSceneCode.userFunc0xaaebc8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
...
gdjs.SplashSceneCode.userFunc0xaaebc8(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xaae348 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
const tokenAuth = runtimeScene.getGame().getVariables().get("sessionAccessToken").getAsString();
const globalUserStruct = runtimeScene.getGame().getVariables().get("currentUser");
...
var objects = [];
objects.push.apply(objects,gdjs.SplashSceneCode.GDtxt_9595debug2Objects3);
gdjs.SplashSceneCode.userFunc0xaae348(runtimeScene, objects);

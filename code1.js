...
};gdjs.MainCode.userFunc0x8e8220 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x8e8220(runtimeScene, objects);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13280284);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13287812);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.asyncCallback13300508 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.MainCode.asyncCallback13300508(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.MainCode.asyncCallback13312180 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.MainCode.asyncCallback13312180(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13311692);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x7a1388 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x7a1388(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x7833e8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
/*
...
gdjs.MainCode.userFunc0x7833e8(runtimeScene, objects);
...
};gdjs.MainCode.asyncCallback13321428 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.MainCode.asyncCallback13321428(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13315468);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x74ba88 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDbad_9595RockObjects3);
gdjs.MainCode.userFunc0x74ba88(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x74bea8 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDtest_9595shipObjects3);
gdjs.MainCode.userFunc0x74bea8(runtimeScene, objects);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13322540);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13324820);
}
}
if (isConditionTrue_0) {

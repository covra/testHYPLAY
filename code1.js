...
gdjs.SplashSceneCode.userFunc0xd65608 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.SplashSceneCode.userFunc0xd65608(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xa76508 = function GDJSInlineCode(runtimeScene) {
"use strict";
setTimeout(()=>{
...
gdjs.SplashSceneCode.userFunc0xa76508(runtimeScene);
...
};gdjs.SplashSceneCode.userFunc0xbe4c18 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
...
gdjs.SplashSceneCode.userFunc0xbe4c18(runtimeScene, objects);
...
};gdjs.SplashSceneCode.userFunc0xd04da0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
const tbd = objects[0];
const tokenAuth = runtimeScene.getGame().getVariables().get("sessionAccessToken").getAsString();
const globalUserStruct = runtimeScene.getGame().getVariables().get("currentUser");
...
var objects = [];
objects.push.apply(objects,gdjs.SplashSceneCode.GDtxt_9595debug2Objects3);
gdjs.SplashSceneCode.userFunc0xd04da0(runtimeScene, objects);

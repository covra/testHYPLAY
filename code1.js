...
};gdjs.MainCode.asyncCallback8996980 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtsExt__AdvancedHTTP__ExecuteRequest.func(runtimeScene, "HYPLAYLogin", runtimeScene.getScene().getVariables().get("statusResponse"), (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)), (runtimeScene) => (gdjs.MainCode.asyncCallback8996980(runtimeScene, asyncObjectsList)));
}
}

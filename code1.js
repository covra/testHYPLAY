...
};gdjs.MainCode.userFunc0x9c6068 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x9c6068(runtimeScene, objects);
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13737124);
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13744652);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.asyncCallback13757348 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.MainCode.asyncCallback13757348(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.MainCode.asyncCallback13769020 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.MainCode.asyncCallback13769020(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13768532);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x9cf5a0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
gdjs.MainCode.userFunc0x9cf5a0(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x9cf9b0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
/*
...
gdjs.MainCode.userFunc0x9cf9b0(runtimeScene, objects);
...
};gdjs.MainCode.asyncCallback13778268 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.MainCode.asyncCallback13778268(runtimeScene, asyncObjectsList)));
}
}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13772308);
}
}
if (isConditionTrue_0) {
...
};gdjs.MainCode.userFunc0x9d0de0 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDbad_9595RockObjects3);
gdjs.MainCode.userFunc0x9d0de0(runtimeScene, objects);

}


};gdjs.MainCode.userFunc0x9d1200 = function GDJSInlineCode(runtimeScene, objects) {
"use strict";
...
var objects = [];
objects.push.apply(objects,gdjs.MainCode.GDtest_9595shipObjects3);
gdjs.MainCode.userFunc0x9d1200(runtimeScene, objects);
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13779380);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(13781660);
}
}
if (isConditionTrue_0) {

...
gdjs.videoCode.asyncCallback16195476 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.videoCode.asyncCallback16195476(runtimeScene, asyncObjectsList)));
}
}

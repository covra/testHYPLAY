...
gdjs.videoCode.asyncCallback16478636 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.videoCode.asyncCallback16478636(runtimeScene, asyncObjectsList)));
}
}
